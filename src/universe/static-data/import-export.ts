...
export const ExportImportsMap: Record<TradeSymbol, TradeSymbol[]> = {
  FRAME_CARRIER: SHIP_IMPORTS,
  FRAME_CRUISER: SHIP_IMPORTS,
  FRAME_DESTROYER: SHIP_IMPORTS,
  FRAME_DRONE: SHIP_IMPORTS,
  FRAME_EXPLORER: SHIP_IMPORTS,
  FRAME_FIGHTER: SHIP_IMPORTS,
  FRAME_FRIGATE: SHIP_IMPORTS,
  FRAME_HEAVY_FREIGHTER: SHIP_IMPORTS,
  FRAME_INTERCEPTOR: SHIP_IMPORTS,
  FRAME_LIGHT_FREIGHTER: SHIP_IMPORTS,
  FRAME_MINER: SHIP_IMPORTS,
  FRAME_PROBE: SHIP_IMPORTS,
  FRAME_RACER: SHIP_IMPORTS,
  FRAME_SHUTTLE: SHIP_IMPORTS,
  FRAME_TRANSPORT: SHIP_IMPORTS,
