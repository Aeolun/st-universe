...
export const factionTraits: Record<FactionTrait, FactionTraitData> = {
  BUREAUCRATIC: {
    name: "Bureaucratic",
    description:
      "Bureaucratic factions are known for their slow and inefficient processes.",
    productivityMultiplier: 0.8,
  },
  SECRETIVE: {
    name: "Secretive",
    description:
      "Secretive factions are known for their secrecy and lack of transparency.",
  },
  CAPITALISTIC: {
    name: "Capitalistic",
    description:
      "Capitalistic factions are known for their focus on profit and wealth.",
    exchangeGoodsCount: 2,
  },
  INDUSTRIOUS: {
    name: "Industrious",
    description:
      "Industrious factions are known for their focus on industry and production.",
  },
  PEACEFUL: {
    name: "Peaceful",
    description:
      "Peaceful factions are known for their focus on peace and diplomacy.",
    productivityMultiplier: 1.2,
  },
  DISTRUSTFUL: {
    name: "Distrustful",
    description:
      "Distrustful factions are known for their lack of trust in others.",
  ...
  MILITARISTIC: {
    name: "Militaristic",
    description:
      "Militaristic factions are known for their militaristic nature.",
  ...
  TECHNOLOGICALLY_ADVANCED: {
    ...
    description:
      "Technologically Advanced factions are known for their technological advancement.",
    researchProductionMultiplier: 1.2,
  },
  VISIONARY: {
    name: "Visionary",
  ...
  COLLABORATIVE: {
    name: "Collaborative",
    description:
      "Collaborative factions are known for their collaborative nature.",
  ...
  RESEARCH_FOCUSED: {
    ...
    description:
      "Research Focused factions are known for their research focus.",
    researchProductionMultiplier: 1.2,
  },
  SELF_INTERESTED: {
    name: "Self Interested",
    description:
      "Self Interested factions are known for their self interested nature.",
    constructionCostMultiplier: 0.8,
  },
  UNITED: {
    name: "United",
  ...
  SELF_SUFFICIENT: {
    ...
    description:
      "Self Sufficient factions are known for their self sufficient nature.",
    maintenanceCostMultiplier: 1.2,
  },
  ADAPTABLE: {
    name: "Adaptable",
    description:
      "Quick to adapt to changing circumstances, with the ability to adjust their plans or strategies in response to new information or challenges. Sometimes able to thrive in a wide range of environments or situations, but may also be vulnerable to sudden or unexpected changes.",
    productivityMultiplier: 1.2,
  },
  STRATEGIC: {
    name: "Strategic",
  ...
  FREE_MARKETS: {
    name: "Free Markets",
    description:
      "Free Markets factions are known for their free market nature.",
    exchangeGoodsCount: 1,
  },
  COMMERCIAL: {
    name: "Commercial",
  ...
  ENTREPRENEURIAL: {
    ...
    description:
      "Entrepreneurial factions are known for their entrepreneurial nature.",
    productivityMultiplier: 1.2,
  },
  RESOURCEFUL: {
    name: "Resourceful",
  ...
  IMPERIALISTIC: {
    name: "Imperialistic",
    description:
      "Imperialistic factions are known for their imperialistic nature.",
    maintenanceCostMultiplier: 1.2,
  },
  INTELLIGENT: {
    name: "Intelligent",
  ...
  UNPREDICTABLE: {
    name: "Unpredictable",
    description:
      "Unpredictable factions are known for their unpredictable nature.",
    weaponDamageMultiplier: 1.2,
  },
  COOPERATIVE: {
    name: "Cooperative",
  ...
  TREASURE_HUNTERS: {
    ...
    description:
      "Treasure Hunters factions are known for their treasure hunting nature.",
    researchProductionMultiplier: 1.2,
  },
};

export const factionTraitNames = Object.keys(factionTraits) as FactionTrait[];
